    ...
    template: `
      <div style="padding: 1.5rem; font-family: var(--ds-typography-font-family-poppins);">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          <tbody>
            <tr v-for="r in rows" :key="r.cssVar" style="border-bottom: 1px solid var(--ds-border-subtlest);">
              <td style="padding: 0.6rem 1rem 0.6rem 0; font-family: monospace; font-size: 0.72rem; color: var(--ds-text-default);">{{ r.cssVar }}</td>
              <td style="padding: 0.6rem 0; font-family: monospace; font-size: 0.7rem; color: var(--ds-text-subtlest); text-align: right;">{{ r.px }}</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    template: `
      <div style="font-family: var(--ds-typography-font-family-poppins);">
        ...
        <div style="background: var(--ds-color-accent-100, #fef7c3); padding: 0 var(--ds-container-padding-desktop); min-height: 320px;">
          <div style="max-width: var(--ds-container-max-width-desktop); margin: 0 auto; background: var(--ds-bg-default); border: 1px dashed var(--ds-border-default); min-height: 320px; padding: var(--ds-spacing-xl);">
            <p style="font-size: var(--ds-font-size-heading-lg); line-height: var(--ds-line-height-heading-lg); letter-spacing: var(--ds-letter-spacing-heading-lg); font-weight: var(--ds-font-weight-heading-lg); color: var(--ds-text-strong); margin: 0 0 0.5rem;">
              Colonne de contenu
            </p>
            <p style="font-family: monospace; font-size: 0.72rem; color: var(--ds-text-subtlest); margin: 0;">
